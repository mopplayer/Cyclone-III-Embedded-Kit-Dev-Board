...
module application_selector_ddr2_sdram (
	local_address,
	local_write_req,
	local_read_req,
	local_burstbegin,
	...
	application_selector_ddr2_sdram_controller_phy	application_selector_ddr2_sdram_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="application_selector_ddr2_sdram_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="application_selector_ddr2_sdram_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="application_selector_ddr2_sdram_phy_alt_mem_phy_seq.vhd,application_selector_ddr2_sdram_phy_alt_mem_phy_seq_wrapper.vhd,application_selector_ddr2_sdram_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="application_selector_ddr2_sdram_auk_ddr_hp_controller_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+application_selector_ddr2_sdram_alt_mem_phy_seq_wrapper;+application_selector_ddr2_sdram_alt_mem_phy_reconfig;+application_selector_ddr2_sdram_alt_mem_phy_pll;+application_selector_ddr2_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\lmong\AppData\Local\Temp\alt5245_3035358865676353384.dir\0006_iptb_gen/application_selector_ddr2_sdram_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="application_selector_ddr2_sdram_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
