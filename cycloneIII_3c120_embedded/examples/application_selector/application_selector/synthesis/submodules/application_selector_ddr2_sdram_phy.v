...
module application_selector_ddr2_sdram_phy (
	pll_ref_clk,
	global_reset_n,
	soft_reset_n,
	ctl_dqs_burst,
	...
	application_selector_ddr2_sdram_phy_alt_mem_phy	application_selector_ddr2_sdram_phy_alt_mem_phy_inst(
	...
	defparam
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6500,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6500 ps",
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1106,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		application_selector_ddr2_sdram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="application_selector_ddr2_sdram_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="76.9"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="application_selector_ddr2_sdram_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="application_selector_ddr2_sdram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+application_selector_ddr2_sdram_phy_alt_mem_phy_seq_wrapper;+application_selector_ddr2_sdram_phy_alt_mem_phy_reconfig;+application_selector_ddr2_sdram_phy_alt_mem_phy_pll;+application_selector_ddr2_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\lmong\AppData\Local\Temp\alt5245_3035358865676353384.dir\0006_iptb_gen/application_selector_ddr2_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="application_selector_ddr2_sdram_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
