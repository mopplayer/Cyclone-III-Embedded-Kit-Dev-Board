...
# ----------------------------------------------------------------
	...
	set corename "application_selector_ddr2_sdram_1_phy"
	array unset pins_t
...
lappend patterns ck_n ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|auto_generated|ddio_outa\[*\]|dataout
	...
	set outputFileName "application_selector_ddr2_sdram_1_phy_autodetectedpins.tcl"
...
set application_selector_ddr2_sdram_1_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_application_selector_ddr2_sdram_1_phy_use_high_performance_timing] != ""} {
	set application_selector_ddr2_sdram_1_phy_use_high_performance_timing $::override_application_selector_ddr2_sdram_1_phy_use_high_performance_timing
}
