...
module ddr2_sdram (
	...
	ddr2_sdram_controller_phy	ddr2_sdram_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr2_sdram_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_sdram_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr2_sdram_phy_alt_mem_phy_seq.vhd,ddr2_sdram_phy_alt_mem_phy_seq_wrapper.vhd,ddr2_sdram_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_sdram_auk_ddr_hp_controller_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_sdram_alt_mem_phy_seq_wrapper;+ddr2_sdram_alt_mem_phy_reconfig;+ddr2_sdram_alt_mem_phy_pll;+ddr2_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\WL\Project\QII_RTA\results\linux64\cycloneIII_3c120_embedded\examples\application_selector/ddr2_sdram_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_sdram_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
