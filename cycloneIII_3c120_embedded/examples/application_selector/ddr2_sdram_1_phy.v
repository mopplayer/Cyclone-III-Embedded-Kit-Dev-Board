...
module ddr2_sdram_1_phy (
	...
	ddr2_sdram_1_phy_alt_mem_phy	ddr2_sdram_1_phy_alt_mem_phy_inst(
	...
	defparam
		ddr2_sdram_1_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		ddr2_sdram_1_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ddr2_sdram_1_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr2_sdram_1_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		ddr2_sdram_1_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ddr2_sdram_1_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		ddr2_sdram_1_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		ddr2_sdram_1_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6500,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6500 ps",
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1106,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ddr2_sdram_1_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
		ddr2_sdram_1_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		ddr2_sdram_1_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr2_sdram_1_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		ddr2_sdram_1_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr2_sdram_1_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "flexible_timing" value="true"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "rank_configuration" value="Single"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_sdram_1_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_sdram_1_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_sdram_1_phy_alt_mem_phy_seq_wrapper;+ddr2_sdram_1_phy_alt_mem_phy_reconfig;+ddr2_sdram_1_phy_alt_mem_phy_pll;+ddr2_sdram_1_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\WL\Project\QII_RTA\results\linux64\cycloneIII_3c120_embedded\examples\application_selector/ddr2_sdram_1_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_sdram_1_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
