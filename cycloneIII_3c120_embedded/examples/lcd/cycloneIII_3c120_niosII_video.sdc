...
set DDR_1_Local_Clock *|the_ddr2_sdram_1|ddr2_sdram_1_controller_phy_inst|alt_mem_phy_inst|*|clk|pll|altpll_component|auto_generated|pll1|clk[1]
set DDR_1_Controller_Clock *|the_ddr2_sdram_1|ddr2_sdram_1_controller_phy_inst|alt_mem_phy_inst|*|clk|pll|altpll_component|auto_generated|pll1|clk[0]
...
## Cutting the paths between the external clock and ddr_1 clock
set_false_path -from [get_clocks {top_clkin_50}] -to [get_clocks $DDR_1_Controller_Clock]
set_false_path -from [get_clocks $DDR_1_Controller_Clock] -to [get_clocks {top_clkin_50}]

set_false_path -from [get_clocks {top_clkin_50}] -to [get_clocks $DDR_1_Local_Clock]
set_false_path -from [get_clocks $DDR_1_Local_Clock] -to [get_clocks {top_clkin_50}]

set_false_path -from [get_clocks {top_clkin_125}] -to [get_clocks $DDR_1_Controller_Clock]
set_false_path -from [get_clocks $DDR_1_Controller_Clock] -to [get_clocks {top_clkin_125}]

set_false_path -from [get_clocks {top_clkin_125}] -to [get_clocks $DDR_1_Local_Clock]
set_false_path -from [get_clocks $DDR_1_Local_Clock] -to [get_clocks {top_clkin_125}]
...
## Cutting the paths between the system clock and ddr1 clock
set_false_path -from [get_clocks $System_Clock_int] -to [get_clocks $DDR_1_Controller_Clock]
set_false_path -from [get_clocks $DDR_1_Controller_Clock] -to [get_clocks $System_Clock_int]

set_false_path -from [get_clocks $System_Clock_int] -to [get_clocks $DDR_1_Local_Clock]
set_false_path -from [get_clocks $DDR_1_Local_Clock] -to [get_clocks $System_Clock_int]
...
## Cutting the paths between the slow periphera clock and ddr1 clock
set_false_path -from [get_clocks $Slow_Clock_int] -to [get_clocks $DDR_1_Controller_Clock]
set_false_path -from [get_clocks $DDR_1_Controller_Clock] -to [get_clocks $Slow_Clock_int]

set_false_path -from [get_clocks $Slow_Clock_int] -to [get_clocks $DDR_1_Local_Clock]
set_false_path -from [get_clocks $DDR_1_Local_Clock] -to [get_clocks $Slow_Clock_int]

#TSE constraints

#Constrain MAC network-side interface clocks
create_clock -period "125 MHz" -name top_tx_clk_to_the_tse_mac [ get_keepers top_HSMB_TX_CLK]
create_clock -period "125 MHz" -name top_rx_clk_to_the_tse_mac [ get_keepers top_HSMB_RX_CLK]
...
# lcd_i2c
set_false_path -to [get_ports {top_HSMB_SCEN}]

# touch_panel_spi
set_false_path -to [get_ports {top_HSMB_ADC_CS_N}]
set_false_path -from [get_ports {top_HSMB_ADC_DOUT}]
set_false_path -to [get_ports {top_HSMB_ADC_DIN}]
set_false_path -from [get_ports {top_HSMB_ADC_PENIRQ_N}]

# id_eeprom
set_false_path -to [get_ports {top_HSMB_ID_I2CSCL}]
set_false_path -to [get_ports {top_HSMB_ID_I2CDAT}]
set_false_path -from [get_ports {top_HSMB_ID_I2CDAT}]
