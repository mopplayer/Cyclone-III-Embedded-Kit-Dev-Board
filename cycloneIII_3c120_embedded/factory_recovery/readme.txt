==================================================
ABOUT THE SDCARD_CONTENTS DIRECTORY
==================================================

What is in the sdcard_contents directory? 
------------------------------- 
The "sdcard_contents" directory is a repository of pre-built example designs that 
...
This directory contains the ready-to-run demos found on your sd-card.
...
2) Software Design Examples:  These build upon hardware design examples and 
...
------------------------------------
   1) For the Embedded Systems Development Kit (ESDK), there are many "Ready to 
      Run" demos available on the SD CARD. 

   2) A menu listing all the demos stored on the SD-Card appears when the system 
      is first powered up. For usage instructions use the LCD Touch Screen to 
      highlight the demo and press the "Info" button.

   3) The "Ready to Run" demos that you see on the display of the Embedded Systems 
      Development Kit can be found in the kit installation directory 
      at <Install Dir>\factory_recovery\sdcard_contents\altera_3C120_apps
...
which come with the Embedded Systems Development Kit, Cyclone III Edition, more 
...
You will find links to partners from www.altera.com/esdk


For more detailed information please read the Embedded Systems Development Kit
(ESDK), Cyclone III Edition Getting Started User Guide in the "documents"
directory of your kit installation.