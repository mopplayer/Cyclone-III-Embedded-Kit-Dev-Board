...
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="altmemddr_phy_alt_mem_phy_seq.vhd,altmemddr_phy_alt_mem_phy_seq_wrapper.vhd,altmemddr_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+altmemddr_alt_mem_phy_seq_wrapper;+altmemddr_alt_mem_phy_reconfig;+altmemddr_alt_mem_phy_pll;+altmemddr_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\Board_Design\Regression_Test\CycloneIII_3C120_dev_kit\11.1 Format\For Testing\c3_3c120_dev\cycloneiii_3c120_dev_niosii_standard/altmemddr_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
