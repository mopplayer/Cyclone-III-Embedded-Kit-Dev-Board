...
module altmemddr_phy (
	...
	defparam
		altmemddr_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		altmemddr_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		altmemddr_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		altmemddr_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		altmemddr_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		altmemddr_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		altmemddr_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		altmemddr_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 7519,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "7519 ps",
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 594,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1024,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		altmemddr_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 72,
		altmemddr_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		altmemddr_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		altmemddr_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		altmemddr_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:      <PRIVATE name = "ref_clk_source" value="osc_clk_1"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="altmemddr_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="altmemddr_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+altmemddr_phy_alt_mem_phy_seq_wrapper;+altmemddr_phy_alt_mem_phy_reconfig;+altmemddr_phy_alt_mem_phy_pll;+altmemddr_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\Board_Design\Regression_Test\CycloneIII_3C120_dev_kit\11.1 Format\For Testing\c3_3c120_dev\cycloneiii_3c120_dev_niosii_standard/altmemddr_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
