...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../bup_3c120_fpga.jdi
...
# Design Name 
# setting SOPC_NAME is bup_3c120_fpga_sopc
SOPC_NAME := bup_3c120_fpga_sopc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8025e8
SOPC_SYSID_FLAG += --sidp=0x8025e8
ELF_PATCH_FLAG  += --sidp 0x8025e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1320807242
SOPC_SYSID_FLAG += --timestamp=1320807242
ELF_PATCH_FLAG  += --timestamp 1320807242
