...
MEM_0 := bup_3c120_fpga_sopc_descriptor_memory
...
$(MEM_2)_HIERARCHICAL_PATH := ssram
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: ssram
ssram: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
