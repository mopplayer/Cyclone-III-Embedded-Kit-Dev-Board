// bup_3c120_fpga_sopc_flash_tristate_bridge_pinSharer_0.v

// This file was auto-generated from altera_tristate_conduit_pin_sharer_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 11.1 173 at 2011.11.09.10:56:00

`timescale 1 ps / 1 ps
module bup_3c120_fpga_sopc_flash_tristate_bridge_pinSharer_0 (
		...
		output wire [3:0]  ssram_bwn_to_the_ssram,           //      .ssram_bwn_to_the_ssram_out
		output wire        ssram_oen_to_the_ssram,           //      .ssram_oen_to_the_ssram_out
		output wire        ssram_wen_to_the_ssram,           //      .ssram_wen_to_the_ssram_out
		...
		output wire        ssram_cen_to_the_ssram,           //      .ssram_cen_to_the_ssram_out
		...
		input  wire [25:0] tcs1_address_out,                 //      .address_out
	...
	wire        pin_sharer_tcs1_arb_valid; // pin_sharer:arb_ext_flash_tcm -> arbiter:sink1_valid
	wire        pin_sharer_tcs0_arb_valid; // pin_sharer:arb_ssram_tcm -> arbiter:sink0_valid

	bup_3c120_fpga_sopc_flash_tristate_bridge_pinSharer_0_pin_sharer pin_sharer (
		.clk                              (clk_clk),                          //      clk.clk
		...
		.ssram_bwn_to_the_ssram           (ssram_bwn_to_the_ssram),           //         .ssram_bwn_to_the_ssram_out
		.ssram_oen_to_the_ssram           (ssram_oen_to_the_ssram),           //         .ssram_oen_to_the_ssram_out
		.ssram_wen_to_the_ssram           (ssram_wen_to_the_ssram),           //         .ssram_wen_to_the_ssram_out
		...
		.ssram_cen_to_the_ssram           (ssram_cen_to_the_ssram),           //         .ssram_cen_to_the_ssram_out
		...
		.arb_ext_flash_tcm                (pin_sharer_tcs1_arb_valid),        // tcs1_arb.valid
		.arb_ssram_tcm                    (pin_sharer_tcs0_arb_valid)         // tcs0_arb.valid
	);

	bup_3c120_fpga_sopc_flash_tristate_bridge_pinSharer_0_arbiter arbiter (
		.clk         (clk_clk),                   //       clk.clk
