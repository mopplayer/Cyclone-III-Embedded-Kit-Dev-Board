...
ENTITY ddr2_btm_phy IS
	PORT (
		pll_ref_clk	: IN STD_LOGIC;
		global_reset_n	: IN STD_LOGIC;
		soft_reset_n	: IN STD_LOGIC;
		ctl_dqs_burst	: IN STD_LOGIC_VECTOR (7 DOWNTO 0);
		ctl_wdata_valid	: IN STD_LOGIC_VECTOR (7 DOWNTO 0);
		ctl_wdata	: IN STD_LOGIC_VECTOR (127 DOWNTO 0);
		ctl_dm	: IN STD_LOGIC_VECTOR (15 DOWNTO 0);
		...
		ctl_doing_rd	: IN STD_LOGIC_VECTOR (7 DOWNTO 0);
		ctl_cal_req	: IN STD_LOGIC;
		ctl_cal_byte_lane_sel_n	: IN STD_LOGIC_VECTOR (3 DOWNTO 0);
		...
		ctl_rdata	: OUT STD_LOGIC_VECTOR (127 DOWNTO 0);
...
ARCHITECTURE SYN OF ddr2_btm_phy IS


	COMPONENT ddr2_btm_phy_alt_mem_phy
	GENERIC (
		FAMILY	: STRING;
...
BEGIN
	...
	ddr2_btm_phy_alt_mem_phy_inst : ddr2_btm_phy_alt_mem_phy
	GENERIC MAP (
		FAMILY => "Cyclone III",
		MEM_IF_MEMTYPE => "DDR2",
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr2_btm_phy_alt_mem_phy" >
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_btm_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value=" --simgen_arbitrary_blackbox=+ddr2_btm_phy_alt_mem_phy_seq --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/build/arc/execute/dir_22132/_0/regtest/devkits/c3_3c120_dev/bts_ddr2btm/ddr2_btm_phy_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_btm_phy_alt_mem_phy_seq_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_btm_phy_alt_mem_phy_seq_wrapper;+ddr2_btm_phy_alt_mem_phy_reconfig;+ddr2_btm_phy_alt_mem_phy_pll;+ddr2_btm_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/build/arc/execute/dir_22132/_0/regtest/devkits/c3_3c120_dev/bts_ddr2btm/ddr2_btm_phy_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_btm_phy.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_btm_phy_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
