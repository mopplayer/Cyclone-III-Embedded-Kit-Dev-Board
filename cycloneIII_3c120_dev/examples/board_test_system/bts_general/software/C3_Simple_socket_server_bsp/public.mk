...
JDI_FILE := C:/altera/10.1/kits/cycloneIII_3c120_dev/examples/board_test_system/bts_general/bts_general.jdi
...
# Design Name 
# setting SOPC_NAME is bts_general_sopc
SOPC_NAME := bts_general_sopc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20003520
SOPC_SYSID_FLAG += --sidp=0x20003520
ELF_PATCH_FLAG  += --sidp 0x20003520

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1311321995
SOPC_SYSID_FLAG += --timestamp=1311321995
ELF_PATCH_FLAG  += --timestamp 1311321995
