...
ENTITY ddr2_top_40 IS
	PORT (
		...
		local_wdata	: IN STD_LOGIC_VECTOR (159 DOWNTO 0);
		local_be	: IN STD_LOGIC_VECTOR (19 DOWNTO 0);
		local_size	: IN STD_LOGIC;
		global_reset_n	: IN STD_LOGIC;
		pll_ref_clk	: IN STD_LOGIC;
		soft_reset_n	: IN STD_LOGIC;
		local_ready	: OUT STD_LOGIC;
		local_rdata	: OUT STD_LOGIC_VECTOR (159 DOWNTO 0);
		...
		mem_dm	: OUT STD_LOGIC_VECTOR (4 DOWNTO 0);
		...
		mem_dqs	: INOUT STD_LOGIC_VECTOR (4 DOWNTO 0)
	);
END ddr2_top_40;

ARCHITECTURE SYN OF ddr2_top_40 IS
	...
	SIGNAL signal_wire6	:  STD_LOGIC_VECTOR (39 DOWNTO 0);
	SIGNAL signal_wire7	:  STD_LOGIC_VECTOR (4 DOWNTO 0);
	SIGNAL signal_wire8	:  STD_LOGIC_VECTOR (4 DOWNTO 0);
	SIGNAL signal_wire9	:  STD_LOGIC_VECTOR (4 DOWNTO 0);
	SIGNAL signal_wire10	:  STD_LOGIC_VECTOR (4 DOWNTO 0);
	SIGNAL signal_wire11	:  STD_LOGIC_VECTOR (4 DOWNTO 0);
	...
	COMPONENT ddr2_top_40_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (22 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
		...
		hc_scan_enable_dq	: IN STD_LOGIC_VECTOR (39 DOWNTO 0);
		hc_scan_enable_dm	: IN STD_LOGIC_VECTOR (4 DOWNTO 0);
		hc_scan_enable_dqs	: IN STD_LOGIC_VECTOR (4 DOWNTO 0);
		hc_scan_enable_dqs_config	: IN STD_LOGIC_VECTOR (4 DOWNTO 0);
		hc_scan_din	: IN STD_LOGIC_VECTOR (4 DOWNTO 0);
		hc_scan_update	: IN STD_LOGIC_VECTOR (4 DOWNTO 0);
		...
		hc_scan_dout	: OUT STD_LOGIC_VECTOR (39 DOWNTO 0);
		...
		mem_dq	: INOUT STD_LOGIC_VECTOR (39 DOWNTO 0);
		mem_dqs	: INOUT STD_LOGIC_VECTOR (4 DOWNTO 0);
		mem_dqsn	: INOUT STD_LOGIC_VECTOR (4 DOWNTO 0)
	);
...
BEGIN
	...
	ddr2_top_40_controller_phy_inst : ddr2_top_40_controller_phy
	PORT MAP (
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr2_top_40_controller_phy" >
...
-- Retrieval info:      <PRIVATE name = "local_if_dwidth_label" value="160"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "mem_if_preset" value="Micron MT47H32M16CC-3_40bits"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "mem_if_dwidth" value="40"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_top_40_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr2_top_40_phy_alt_mem_phy_seq_wrapper.vhd,ddr2_top_40_phy_alt_mem_phy_seq_wrapper.v,ddr2_top_40_phy.vhd,ddr2_top_40_phy_alt_mem_phy.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="ddr2_top_40_phy.vho,ddr2_top_40_phy_alt_mem_phy_seq_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_top_40_auk_ddr_hp_controller_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_top_40_alt_mem_phy_seq_wrapper;+ddr2_top_40_alt_mem_phy_reconfig;+ddr2_top_40_alt_mem_phy_pll;+ddr2_top_40_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\_Netbean\cyclone3_3c120_dev\bts_ddr2_top_40\bts_ddr2/ddr2_top_40_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="ddr2_top_40_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "quartus_settings">
-- Retrieval info:      <PRIVATE name = "DEVICE" value="EP3C120F780C8"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "FAMILY" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
