...
module ddr2_top_40_phy (
	...
	input		soft_reset_n;
	input	[9:0]	ctl_dqs_burst;
	input	[9:0]	ctl_wdata_valid;
	input	[159:0]	ctl_wdata;
	input	[19:0]	ctl_dm;
	input	[25:0]	ctl_addr;
	input	[3:0]	ctl_ba;
	input	[1:0]	ctl_cas_n;
	...
	input	[9:0]	ctl_doing_rd;
	input		ctl_cal_req;
	input	[4:0]	ctl_cal_byte_lane_sel_n;
	input		dbg_clk;
	input		dbg_reset_n;
	input	[12:0]	dbg_addr;
	input		dbg_wr;
